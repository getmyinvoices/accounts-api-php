...
class RestClient
{
    ...
    public function getmethod($api_key, $param, $method)
    {
        ...
        try {
            $result = $this->httpClient->request('GET', $apiMethodUrl, [
    ...
    public function post($api_key, $param, $method)
    {
        ...
        try {
            $result = $this->httpClient->request('POST', $apiMethodUrl, [
                'verify' => $this->sslVerify,
                'json' => $param,
                'timeout' => $this->timeout,
                'headers' => [
    ...
    public function put($api_key, $param, $method)
    {
        ...
        try {
            $result = $this->httpClient->request('PUT', $apiMethodUrl, [
                'verify' => $this->sslVerify,
                'json' => $param,
                'timeout' => $this->timeout,
                'headers' => [
    ...
    public function delete($api_key, $method)
    {
        ...
        try {
            $result = $this->httpClient->request('DELETE', $apiMethodUrl, [
                'verify' => $this->sslVerify,
                'timeout' => $this->timeout,
                'headers' => [
                    'Accept' => 'application/json',
